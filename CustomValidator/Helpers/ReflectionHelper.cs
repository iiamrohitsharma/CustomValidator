...
namespace CustomValidator.Helpers
{
    ...
    public static class ReflectionHelper
    {
        ...
        public static PropertyInfo GetProperty(Type type, string propertyName)
        {
            ...
            if (property == null)
            {
                throw new InvalidOperationException(string.Format("The property '{0}' was not found on type '{1}'.", propertyName, type));
            }
        ...
        public static object InvokeMethod(object target, string methodName, params object[] parameters)
        {
            ...
            if (method == null)
            {
                throw new InvalidOperationException(string.Format("The method '{0}' was not found on type '{1}'.",methodName,objType.Name));
            }
